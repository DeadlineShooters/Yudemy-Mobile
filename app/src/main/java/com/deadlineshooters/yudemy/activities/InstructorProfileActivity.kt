...
class InstructorProfileActivity : BaseActivity() {
    ...
    private val dumpInst = User("Brad Schiff", arrayListOf(), arrayListOf(), arrayListOf(), arrayListOf(), arrayListOf(),false, "",Instructor("Web developer",100, 100, dumpBio, Image("secure_url", "public_id"), "walletId", "walletName"))
    private var isExpanded = true
    private val dumpCourse1 = Course("123", "Become a Web Developer: 2024 Bootcamp", "Brad Schiff", 1000, "Become a full-stack web developer with just one course. HTML, CSS, Javascript, Node, React, MongoDB and more!", "Become a full-stack web developer with just one course. HTML, CSS, Javascript, Node, React, MongoDB and more!", 199.99, arrayListOf("Introduction", "HTML", "CSS", "Javascript", "Node", "React", "MongoDB", "Final Project"), Video("secure_url", "public_id"), "English", "Web Development", 100, 8, 10000, 10, Image("secure_url", "public_id"), 1000, 4.8, true, "12/12/2021", 100000)
    private val dumpCourse2 = Course("124", "Let's Learn Laravel: A Guided Path For Beginners", "Brad Schiff", 1000, "Become a full-stack web developer with just one course. HTML, CSS, Javascript, Node, React, MongoDB and more!", "Become a full-stack web developer with just one course. HTML, CSS, Javascript, Node, React, MongoDB and more!", 199.99, arrayListOf("Introduction", "HTML", "CSS", "Javascript", "Node", "React", "MongoDB", "Final Project"), Video("secure_url", "public_id"), "English", "Web Development", 100, 8, 10000, 10, Image("secure_url", "public_id"), 1000, 4.8, true, "12/12/2021", 100000)
    private val dumpCourse3 = Course("125", "MySQL For Beginners: Real Database Experience Real Fast", "Brad Schiff", 1000, "Become a full-stack web developer with just one course. HTML, CSS, Javascript, Node, React, MongoDB and more!", "Become a full-stack web developer with just one course. HTML, CSS, Javascript, Node, React, MongoDB and more!", 199.99, arrayListOf("Introduction", "HTML", "CSS", "Javascript", "Node", "React", "MongoDB", "Final Project"), Video("secure_url", "public_id"), "English", "Web Development", 100, 8, 10000, 10, Image("secure_url", "public_id"), 1000, 4.7, true, "12/12/2021", 100000)
